...
def get_num_epochs(n_iters, batch_size):
    return int(n_iters / (len(features) / batch_size))

def create_dataloader(batch_size, random_state):
...
writer = SummaryWriter('project/models/neural_network/runs')
...
if __name__ == '__main__':
    ...
    num_epochs = get_num_epochs(3000, 100)
